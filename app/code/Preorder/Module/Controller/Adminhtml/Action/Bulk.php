...
use Magento\Framework\App\Action\Context as Con;
use Magento\Ui\Component\MassAction\Filter as F;
use Magento\Framework\Controller\ResultFactory;
use Magento\Framework\View\Result\PageFactory as PFUse;
use Preorder\Module\Model\ModuleFactory;
use Preorder\Module\Model\ResourceModel\Module\CollectionFactory as CFUse;
...
class Bulk extends Action
{
     ...
     */
    public function __construct(Con $context, PFUse $resultPF, Emaill $helper, F $filter, CFUse $cF, ModuleFactory $mF)
    {
        $this->_resultPageFactory = $resultPF;
        $this->_helper = $helper;
        $this->moduleFactory = $mF;
        $this->filter = $filter;
    ...
    {
        return $this->filter->getComponentRefererUrl() ?: 'preorder_grid/*/indexx';
    }
